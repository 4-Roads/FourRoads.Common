    ...
    public static class SqlDataExtensions
    {
        ...
        public static SqlDbType ToSqlDbType(this DbType dataType)
        {
            switch (dataType)
            {
                ...
                case DbType.SByte: throw new ArgumentException(string.Format("DbType '{0}' cannot be translated to SqlDbType", dataType.ToString()));
                case DbType.Single: return SqlDbType.Real;
                case DbType.String: return SqlDbType.NVarChar;
                case DbType.UInt16: throw new ArgumentException(string.Format("DbType '{0}' cannot be translated to SqlDbType", dataType.ToString()));
                case DbType.UInt32: throw new ArgumentException(string.Format("DbType '{0}' cannot be translated to SqlDbType", dataType.ToString()));
                case DbType.UInt64: throw new ArgumentException(string.Format("DbType '{0}' cannot be translated to SqlDbType", dataType.ToString()));
                case DbType.VarNumeric: throw new ArgumentException(string.Format("DbType '{0}' cannot be translated to SqlDbType", dataType.ToString()));
                ...
                case (DbType)DbType2.Text: return SqlDbType.Text;
                case (DbType)DbType2.NText: return SqlDbType.NText; 
                default:
                    throw new ArgumentException(string.Format("Unkown DbType '{0}' cannot be translated to SqlDbType", dataType.ToString()));
            }
        }
        ...
        public static DbType ToDbType(this SqlDbType dataType)
        {
            switch (dataType)
            {
                ...
                default:
                    throw new ArgumentException(string.Format("Unkown SqlDbType '{0}' cannot be translated to DbType", dataType.ToString()));
            }
        }
